...
def find_difference(image1, image2):
    assert image1.shape == image2.shape, "Specify 2 images with tha same shape."
    gray1_image1 = rgb2gray(image1)
    gray1_image2 = rgb2gray(image2)

    (score, difference_image) = structural_similarity(gray1_image1, gray1_image2, full=True)
